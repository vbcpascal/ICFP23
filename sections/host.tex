...
The above definition can be formalized as $strl$, whose input in the set of expression variables and a bone, and the output is whether the bone is structural. 
