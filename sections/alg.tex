...
We have already exemplified how lambda abstractions break the abstraction property in semantics derivation.
...
In overview, the core idea of the semantics derivation has been shown: 
...
With the semantics derivation algorithm, the evaluation rules of $L'$ are generated.
...
Since the lambda abstraction in the translation rules has been defined as a new translation rules by lambda exposure, 
...
\begin{theorem}
  Lambda exposure maintains the abstraction.
\end{theorem}
